...
\[
\EE\left[\prod_{k=1}^m
\left(\sum_{i=1}^N\exp\left(a_k\frac{\lambda_i}{\sqrt{N}}\right)-\EE\sum_{i=1}^N\exp\left(a_k\frac{\lambda_i}{\sqrt{N}}\right)\right)\right] \to \text{expressions of the Wick's formula in Lemma \ref{lem:12.1}}.
\]
